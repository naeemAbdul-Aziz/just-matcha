      ...
      <div className="space-y-5">
        ...
        <div className="relative group">
          <input
            type="text"
            id="name"
            className="block w-full px-6 py-4 text-brand-dark dark:text-white bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-full focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent peer transition-all shadow-sm placeholder-transparent"
            placeholder="Full Name"
          />
          <label
            htmlFor="name"
            className="absolute left-6 top-4 text-slate-400 dark:text-slate-500 transition-all duration-200 pointer-events-none origin-[0] peer-focus:-translate-y-3 peer-focus:scale-75 peer-focus:text-brand-dark peer-not-placeholder-shown:-translate-y-3 peer-not-placeholder-shown:scale-75 peer-not-placeholder-shown:text-brand-dark"
          >
            Full Name
          </label>
        </div>
        ...
        <div className="relative group">
          ...
          <span className="material-icons absolute right-6 top-4 text-slate-300 pointer-events-none">location_on</span>
        </div>
      </div>
    </section>
  );
