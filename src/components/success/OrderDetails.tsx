...
export const OrderDetails: React.FC = () => {
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl p-6 shadow-lg shadow-slate-200/50 dark:shadow-none">
      ...
      <div className="flex gap-4 mb-6">
        <div className="h-20 w-20 rounded-lg bg-slate-50 dark:bg-slate-800 flex-shrink-0 overflow-hidden relative">
          <img
        ...
        <div className="flex-grow">
          <div className="flex justify-between items-start">
            ...
            <span className="font-semibold text-slate-900 dark:text-white">$8.50</span>
          </div>
      ...
      <div className="flex gap-4 mb-6">
        ...
        <div className="flex-grow">
          <div className="flex justify-between items-start">
            ...
            <span className="font-semibold text-slate-900 dark:text-white">$4.00</span>
          </div>
